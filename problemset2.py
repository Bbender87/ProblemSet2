...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        if (self.x, self.y) not in self.isCleaned:
            self.isCleaned.append((self.x, self.y))
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        """ Returns a random float 0-1. Does output rely on an int?"""
